...
Obj44.onmousedown = function(event) {

      let shiftX = event.clientX - Obj44.getBoundingClientRect().left;
      let shiftY = event.clientY - Obj44.getBoundingClientRect().top;

      Obj44.style.position = 'absolute';
      Obj44.style.zIndex = 1000;
      document.body.append(Obj44);

      moveAt(event.pageX, event.pageY);

      function moveAt(pageX, pageY) {
        Obj44.style.left = pageX - shiftX + 'px';
        Obj44.style.top = pageY - shiftY + 'px';
      }
      ...
      Obj44.onmouseup = function() {
        document.removeEventListener('mousemove', onMouseMove);
        Obj44.onmouseup = null;
      };
    };

Obj45.onmousedown = function(event) {

      let shiftX = event.clientX - Obj45.getBoundingClientRect().left;
      let shiftY = event.clientY - Obj45.getBoundingClientRect().top;

      Obj45.style.position = 'absolute';
      Obj45.style.zIndex = 1000;
      document.body.append(Obj45);

      moveAt(event.pageX, event.pageY);

      function moveAt(pageX, pageY) {
        Obj45.style.left = pageX - shiftX + 'px';
        Obj45.style.top = pageY - shiftY + 'px';
      }
      ...
      Obj45.onmouseup = function() {
        document.removeEventListener('mousemove', onMouseMove);
        Obj45.onmouseup = null;
      };
    };
Obj46.onmousedown = function(event) {

      let shiftX = event.clientX - Obj46.getBoundingClientRect().left;
      let shiftY = event.clientY - Obj46.getBoundingClientRect().top;

      Obj46.style.position = 'absolute';
      Obj46.style.zIndex = 1000;
      document.body.append(Obj46);

      moveAt(event.pageX, event.pageY);

      function moveAt(pageX, pageY) {
        Obj46.style.left = pageX - shiftX + 'px';
        Obj46.style.top = pageY - shiftY + 'px';
      }
      ...
      Obj46.onmouseup = function() {
        document.removeEventListener('mousemove', onMouseMove);
        Obj46.onmouseup = null;
      };
    };
Obj47.onmousedown = function(event) {

      let shiftX = event.clientX - Obj47.getBoundingClientRect().left;
      let shiftY = event.clientY - Obj47.getBoundingClientRect().top;

      Obj47.style.position = 'absolute';
      Obj47.style.zIndex = 1000;
      document.body.append(Obj47);

      moveAt(event.pageX, event.pageY);

      function moveAt(pageX, pageY) {
        Obj47.style.left = pageX - shiftX + 'px';
        Obj47.style.top = pageY - shiftY + 'px';
      }
      ...
      Obj47.onmouseup = function() {
        document.removeEventListener('mousemove', onMouseMove);
        Obj47.onmouseup = null;
      };
    };
    ...
    Obj44.ondragstart = function() {
      return false;
    };
    Obj45.ondragstart = function() {
      return false;
    };
    Obj46.ondragstart = function() {
      return false;
    };
    Obj47.ondragstart = function() {
      return false;
    };
